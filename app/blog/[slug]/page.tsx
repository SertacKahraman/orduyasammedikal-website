...
const fallbackSections: BlogSection[] = [
  ...
  },
  {
    ...
    title: "Medikal Cihaz ve Ürün Seçiminde Dikkat Edilecekler",
    paragraphs: [
      "Kullanılacak medikal cihazın kişinin kilosuna, hastalığın seyrine ve doktor tavsiyesine uygun olması en önemli kriterdir.",
      "Yanlış medikal ürün kullanımı faydadan çok zarar getirebileceğinden, satın alma öncesi mutlaka uzman desteği alınmalıdır.",
    ],
  },
  {
    id: "ordu-rehberi",
    title: "Ordu'da Güvenilir Medikal Destek",
    paragraphs: [
      "Ordu ve çevresinde hasta yatağı, solunum cihazı veya tekerlekli sandalye gibi medikal ihtiyaçlarınızda, satış sonrası teknik destek sunan kurumsal firmaları tercih etmeniz yaşanabilecek mağduriyetleri önler.",
    ],
  },
];
...
const officialReferences: Record<string, { label: string; href: string }[]> = {
  "evde-hasta-bakimi-en-uygun-hasta-yatagi-nasil-secilir": [
    {
      label: "Sağlık Bakanlığı: Yatağa Bağımlı Hastanın Evde Bakımı",
      href: "https://antalyaeahesh.saglik.gov.tr/TR-64145/yataga-bagimli-hastanin-evde-bakimi-ve-semptom-yonetimi.html",
    },
  ],
  ...
  "ortopedik-tabanlik-ayak-ve-bel-agrilari": [
    {
      label: "NHS: Ayak Tabanlıkları Hakkında Bilgilendirme",
      href: "https://www.guysandstthomas.nhs.uk/health-information/foot-insoles",
    },
  ],
  "ayak-sagligi-icin-en-iyi-medikal-terlikler": [
    {
      label: "NHS: Ayak Sağlığı, Destekleyici Ayakkabı ve Tabanlıklar",
      href: "https://www.dorsethealthcare.nhs.uk/our-services-and-sites/physical-health/orthotics-insoles-braces-and-supports/purchasing-shelf-orthotic-aids-and-how-manage-common-foot-pains",
    },
  ],
  "tansiyon-aleti-alirken-dikkat-edilmesi-gerekenler": [
    {
      label: "Sağlık Bakanlığı: Tansiyonu Doğru Ölçme Rehberi",
      href: "https://hsgm.saglik.gov.tr/depo/birimler/kronik-hastaliklar-ve-yasli-sagligi-db/Dokumanlar/Brosurler/Kan_Bas_nc_Tansiyon_l_m_.pdf",
    },
  ],
  "astim-koah-nebulizator-secimi-ve-kullanim-ipuclari": [
    {
      label: "Dünya Sağlık Örgütü: Tıbbi Oksijen ve Cihaz Güvenliği",
      href: "https://www.who.int/teams/health-product-and-policy-standards/assistive-and-medical-technology/medical-devices/oxygen",
    },
  ],
  "seker-olcum-cihazi-glukometre-secimi-ve-dogru-olcum": [
    {
      label: "CDC: Evde Kan Şekeri Ölçümü",
...
export default async function BlogDetailPage({ params }: BlogDetailPageProps) {
  ...
  const references = officialReferences[post.slug] ?? [];
  ...
  return (
    <>
      <article className="scroll-reveal bg-[#F8F1EA] px-4 pb-20 pt-28 sm:px-6 sm:pb-28 sm:pt-32 lg:px-8">
          ...
          <main>
            <div className="reveal-item max-w-5xl">
              ...
              <div className="relative mt-8 min-h-[320px] overflow-hidden rounded-[22px] bg-[#E8C9B2] sm:min-h-[430px] lg:min-h-[470px]">
                <Image
                  src={post.image}
                  alt={`${post.title} - Ordu Yaşam Medikal`}
                  fill
            ...
            <div className="rounded-[24px] bg-[#F2DED1] p-6 shadow-[0_22px_80px_rgba(58,42,36,0.08)] ring-1 ring-[#D9AD91]/75">
              ...
              <section className="mt-9">
                ...
                <p className="mt-3 text-sm leading-6 text-[#5F4E46]">
                  İhtiyacınıza uygun medikal ürün seçenekleri, stok ve fiyat bilgisi için WhatsApp üzerinden bize ulaşın.
                </p>
                <Link
                  href="/iletisim"
        ...
        <aside className="reveal-item mx-auto mt-12 w-full max-w-5xl rounded-[18px] border border-[#DDB89F]/70 bg-[#FFF8F3] p-5 text-sm leading-7 text-[#5F4E46]">
          <p className="font-semibold text-[#3A2A24]">Sağlık bilgilendirmesi</p>
          <p className="mt-2 max-w-3xl">
            Bu içerik genel bilgilendirme amacıyla hazırlanmıştır; tanı veya tedavi önerisi
            değildir. Cihaz seçimi ve kullanımında hekiminizin önerisi ile ürünün resmî kullanım
            ...
            <div className="mt-3 flex flex-wrap gap-x-4 gap-y-2">
              {references.map((reference) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-semibold text-[#7A3429] underline decoration-[#DDB89F] underline-offset-4 transition hover:text-[#3A2A24]"
                >
                  {reference.label}
                </a>
              ))}
