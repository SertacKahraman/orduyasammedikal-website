...
export const metadata: Metadata = generateStaticPageMetadata(
  "İletişim ve Sipariş",
  "Ordu Yaşam Medikal Altınordu mağazasının adres, telefon, WhatsApp, çalışma saatleri ve harita bilgilerine ulaşın; ürün ve stok bilgisi alın.",
  "/iletisim",
);
...
const contactCards = [
  ...
  },
  {
    ...
    description: "Sipariş ve hızlı bilgi için arayabilirsiniz.",
    icon: "phone",
...
const contactFaqs = [
  {
    ...
    answer: "Çalışma saatleri içinde gelen mesajlara mümkün olan en kısa sürede dönüş yapılır. Yanıt süresi yoğunluk durumuna göre değişebilir.",
  },
  {
    question: "Mağazanıza gelmeden ürün alabilir miyim?",
    answer: "Evet, WhatsApp veya telefon üzerinden sipariş verebilir, adrese teslimat talep edebilirsiniz.",
  },
  {
    question: "Sipariş verirken neleri belirtmeliyim?",
    answer: "İstediğiniz ürünü, teslimat adresini ve varsa hastanın özel ihtiyaçlarını (örn. yatağın motor sayısı) paylaşmanız yeterlidir.",
  },
  {
    question: "Havalı yatak veya cihaz kurulumu yapıyor musunuz?",
    answer: "Evet, büyük hacimli ürünlerde ve karmaşık medikal cihazlarda Ordu içi kurulum ve kullanım bilgilendirmesi yapıyoruz.",
  },
  {
    question: "Konum ve çalışma saatleri güncel mi?",
    answer: "Evet, sayfadaki konum ve çalışma saatlerimiz günceldir. Yine de mağazayı ziyaret etmeden önce iletişim numaralarımızdan teyit alabilirsiniz.",
  },
];
        ...
        <section className="px-4 pb-16 pt-28 sm:px-6 sm:pb-20 sm:pt-32 lg:px-8">
          <div className="mx-auto max-w-7xl">
            <div className="max-w-3xl">
              ...
              >
                Sipariş oluşturmak, ürünler hakkında bilgi almak veya stok durumunu öğrenmek için
            ...
            <div id="harita" className="contact-panel-reveal" style={{ animationDelay: "760ms" }}>
              ...
              <div className="mt-7 overflow-hidden rounded-2xl border border-[#DDB89F]/55 bg-[#E8C9B2] shadow-[0_18px_55px_rgba(58,42,36,0.08)]">
                <iframe
                  ...
                  title="Ordu Yaşam Medikal harita konumu"
                  allowFullScreen
                  loading="lazy"
